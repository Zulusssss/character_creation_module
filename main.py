...
def attack(char_name: str, char_class: str) -> str:
    """Return string of attack witn the points of damage."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return string of defence witn the points of defence."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return string of special abiluty witn the result of ability."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Propouse turn your name, choose class."""
